...
(function () {
    var SILENCE_NONE = 0, SILENCE_ABILITIES = 1, SILENCE_PASSIVES = 2, SILENCE_ALL = 3;
    var ABILITY_STATE_DEFAULT = 0, ABILITY_STATE_ACTIVE = 1, ABILITY_STATE_ABILITY_PHASE = 2, ABILITY_STATE_COOLDOWN = 3;
